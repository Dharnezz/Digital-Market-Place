...
3. **Build & run:**
   ```bash
   cd backend
   ./mvnw.cmd test                 # run the 155 JUnit 5 tests
...
- **Backend:** 155 tests via JUnit 5 — entity/repository structure contracts, service unit tests,
...
- ✅ **Backend** — 11 entities, 11 repositories, 8 services, 11 controllers, JWT security,
  validation, RFC 7807 errors, guarded product lifecycle, **155 tests passing**, Swagger docs.
